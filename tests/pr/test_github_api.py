...
class TestBuildStateFilter:
    ...
    def client(self):
        ...
        with patch("src.pr.github_api.get_github_token", return_value="test-token"):
            with patch("src.pr.github_api.GitHubClient"):
...
class TestSearchPRs:
    ...
    def test_search_prs_returns_results(self, mock_graphql_response):
        ...
        with patch("src.pr.github_api.get_github_token", return_value="test-token"):
            with patch("src.pr.github_api.GitHubClient") as mock_client_class:
